...
for (let i = 0; i < months; i += 1) {
    ...
    let borderRadius;
    if (i === 0) {
        borderRadius = `${global.width.stick / 2}px ${global.width.stick /
            2}px 0 0`;
    } else if (i === months - 1) {
        borderRadius = `0 0 ${global.width.stick / 2}px ${global.width.stick /
            2}px`;
    } else {
        borderRadius = null;
    }
...
class Experience extends PureComponent {
    ...
    select(i) {
        this.setState({
            ...this.state,
            select: i === this.state.select ? -1 : i
        });
    }
