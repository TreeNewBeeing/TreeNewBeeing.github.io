...
function generateImages(images) {
    ...
    for (let i = 0; i < images.length; i += 1) {
        ...
        images[i].transform = `translate(
                ${0 + ((i % num) * 100) / (num - 1)}vw,
                ${(Math.random() * 2 - 1) * 0.4 * global.height.picture +
...
function focusImage(images, n) {
    ...
    for (let i = 0; i < images.length; i += 1) {
        images[i].transform = `translate(
                ...
                ${(Math.random() * 2 - 1) * 0.1 * global.height.picture +
                    ((i % num) * global.height.school) / (num - 1)}px
            )
            rotate(${(Math.random() * 2 - 1) * 45}deg)`;
    }
...
const styles = {
    ...
    superLayer: {
        ...
        zIndex: 200,
        transition1:
            "transform 0.3s ease-in-out, border-radius 0.3s ease-in-out, background-color 0.3s ease-in-out",
...
class School extends PureComponent {
    ...
    unfocus = () => {
        this.setState({
            ...this.state,
            focus: false,
            displacement: -(global.height.school - 35)
        });
    };
    ...
    drag = event => {
        ...
        const pos =
            event.screenY ||
            (event.changedTouches ? event.changedTouches[0].screenY : -1);
        ...
        if (pos < 0) {
            ...
            this.setState({
                ...this.state,
                displacement: this.state.focus
                    ? displacement
                    : displacement - global.height.school
            });
        }
    };
    ...
    drop = () => {
        ...
        this.setState({
            ...this.state,
            focus: this.direction > 0 ? true : false,
            moving: false,
        ...
        return (
            ...
            >
                <div
                    style={{
                        ...styles.superLayer,
                        transform: this.state.first
                            ? "translate(0%,-100%)"
                            : `translate(0px,${this.state.displacement}px)`,
                        transition: this.state.moving
                            ? styles.superLayer.transition2
                            : styles.superLayer.transition1,
                ...
                >
                    ...
                    <div style={styles.p}>
                        ...
                        <ul className="scroll" style={styles.courses}>
                            <li className="clearfix" style={styles.course}>
